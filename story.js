...
const GAME_DATA = {
  characters: [
    {
      ...
      name: "호갱",
      status: "실종",
      description: "말단에 입사한 직원. 마지막 통신은 03:17에 종료되었다. 실종되기 전 “지원 부탁드려요요오오오”라는 말을 남겼다."
    },
    {
      id: "gamja",
      label: "조사원 12",
      name: "감자",
      status: "실종 추정",
      description: "말단에 입사한 직원. 자신 있는 괴담이라고 들어간 이후 실종된 것으로 확인. 현재 식량을 보유하고 있으며 호갱과 같이 있을 가능성이 높다."
    },
    {
      id: "lazy",
      label: "미확인 사용자",
  ...
  rules: [
    ...
    { id:"hall", title:"무한 복도 통과 수칙", place:"별관 3층", lines:[
      ...
      "복도 끝에서 ‘지원 부탁드려요요오오오’가 들리면 소리의 반대 방향으로 걸으십시오.",
    ...
    { id:"phone", title:"미등록 통신 응답 수칙", place:"통신실", lines:[
      ...
      "상대가 귀차니즘이라고 밝히면 ‘애인은 안전하다’고 한 번만 말하십시오."
    ]},
    { id:"mirror", title:"거울 속 직원 확인 수칙", place:"세면실", lines:[
      "거울 속 직원의 사원증 번호가 역순이면 시선을 내리십시오.",
      "거울 속 호갱이 도움을 청해도 손을 내밀지 마십시오.",
      "거울이 먼저 웃으면 조명을 끄고 17초 동안 숨을 참으십시오."
    ]},
  ...
  cases: {
    case1: {
      code:"NDA-0317",
      title:"03:17 무한 복도",
      summary:"호갱의 마지막 통신이 끊긴 별관 3층을 조사한다.",
      start:"s1",
      scenes:{
        s1:{ messages:[
          ["SYSTEM","별관 3층에서 조사원 04의 사원증 신호가 감지됩니다."],
          ["UNKNOWN","지원 부탁드려요요오오오—"]
        ], choices:[
        ...
        s2:{ messages:[
          ...
          ["호갱?","드디어 왔네요. 손 좀 잡아 주세요."]
        ], choices:[
          {text:"손을 잡는다", end:"손이 차갑지 않았습니다. 당신의 사원증 이름이 호갱으로 바뀌었습니다.", effects:{danger:4}, ending:"bad_hogeng"},
          ...
          {text:"도망친다", end:"복도는 처음 위치로 돌아왔습니다.", effects:{danger:1}}
        ]},
        s3:{ messages:[
        ...
        s4:{ messages:[["SYSTEM","엘리베이터 표시층이 4와 04를 번갈아 표시합니다."]], choices:[
          {text:"4층 버튼을 누른다", end:"문이 열리자 복도에 당신의 실종 보고서가 붙어 있었습니다.", effects:{danger:4}, ending:"bad_elevator"},
        ...
        s5:{ messages:[
          ...
          {text:"현재 위치를 계속 묻는다", end:"상대는 ‘당신 뒤’라고만 반복했습니다.", effects:{danger:2}},
    ...
    case2: {
      code:"NDA-B2",
      title:"폐쇄 구내식당",
      summary:"식량을 보유한 감자의 흔적을 추적한다.",
      start:"a1",
      scenes:{
        a1:{ messages:[
          ["SYSTEM","지하 식당 냉장고에서 사람의 체온이 감지됩니다."],
          ["감자","배고프면 들어오세요. 음식은 아직 많아요."]
        ], choices:[
        ...
        a2:{ messages:[
          ["SYSTEM","냉장고 안에는 감자 봉지와 사람 손자국이 있습니다."],
          ["감자","그거 말 걸죠? 대답하면 안 돼요."]
        ], choices:[
          {text:"감자 봉지에 대답한다", end:"봉지 안에서 당신의 목소리가 들렸습니다.", effects:{danger:4}, ending:"bad_canteen"},
          ...
          {text:"손자국을 따라간다", end:"비상창고에서 감자의 배낭과 식량을 발견했습니다.", effects:{investigation:3,gamja:1}, flag:"감자의 배낭", character:"gamja"}
        ]},
        a3:{ messages:[
          ["방송","오늘의 직원은 조사원 12입니다."],
          ["감자","메뉴판 보지 마요. 저거 나 아니에요."]
        ], choices:[
          {text:"방송실로 간다", end:"방송실에는 마이크 대신 사람의 혀가 놓여 있었습니다.", effects:{danger:2,investigation:2}},
          {text:"식당을 즉시 떠난다", end:"출구 앞에서 감자가 던진 통조림을 발견했습니다.", effects:{recovery:10,gamja:2}, flag:"감자의 통조림", character:"gamja"},
          {text:"“진짜 감자는 어디 있지?”라고 묻는다", end:"천장에서 ‘호갱 옆’이라는 답이 들렸습니다.", effects:{gamja:3,danger:1}, flag:"감자의 위치 단서", character:"gamja"}
        ]},
        a4:{ messages:[
          ["감자","호갱이랑 같이 있었어요. 근데 복도가 우리를 갈라놨어요."],
          ["감자","식량은 반씩 나눴어요. 반드시 살아 있을 거예요."]
        ], choices:[
          {text:"반드시 둘 다 찾겠다고 약속한다", end:"감자는 웃으며 비상창고 암호를 알려주었습니다.", effects:{gamja:4,hogeng:1,recovery:10}, flag:"비상창고 1204", character:"gamja"},
          {text:"호갱만 먼저 찾겠다고 한다", end:"감자의 통신이 끊겼습니다.", effects:{gamja:-2,hogeng:2}},
          {text:"감자에게 현재 식량을 묻는다", end:"남은 식량은 정확히 두 사람분입니다.", effects:{investigation:2,gamja:1}}
        ]},
        a5:{ messages:[["SYSTEM","메뉴판: 오늘의 직원 / 감자 / 귀하"]], choices:[
          {text:"메뉴판을 찢는다", end:"찢어진 조각마다 당신의 이름이 적혀 있습니다.", effects:{danger:2}},
          {text:"눈을 감고 출구로 간다", end:"발밑에서 수칙서 한 장을 밟았습니다.", effects:{recovery:9}, rule:"canteen"},
          {text:"감자의 이름을 지운다", end:"식당 안 모든 음식이 썩기 시작했습니다.", effects:{gamja:-3,danger:1}}
        ]}
      }
    },
    ...
    case3: {
      ...
      scenes:{
        b1:{ messages:[
          ...
          ["귀차니즘","혹시 이거 협회 맞아요? 저 집에 가야 하는데요."]
        ], choices:[
          ...
          {text:"통신을 끊는다", end:"통신은 끊겼지만 휴대전화에 ‘왜 끊었어요’가 표시됩니다.", effects:{danger:-1}}
        ]},
        b2:{ messages:[
          ["귀차니즘","2학년인 건 맞는데 반은 잘 모르겠어요. 교실이 계속 바뀌거든요."],
          ...
          {text:"복도로 나오라고 한다", end:"복도 방송이 귀차니즘의 이름을 세 번 불렀습니다.", effects:{danger:2}},
          {text:"책상 밑에 숨으라고 한다", end:"방송이 멎고 통신이 안정되었습니다.", effects:{lazy:3,recovery:10}, flag:"귀차니즘 생존 신호", character:"lazy", rule:"school"}
        ]},
        b3:{ messages:[["귀차니즘","애인한테 연락해야 해요. 근데 제 폰 화면에 제가 아니라 다른 사람이 보여요."]], choices:[
          {text:"휴대전화 화면을 보지 말라고 한다", end:"귀차니즘은 지시에 따랐고 화면 속 인물이 사라졌습니다.", effects:{lazy:4,recovery:10}, flag:"귀차니즘 신뢰", character:"lazy", rule:"phone"},
          {text:"애인의 이름을 묻는다", end:"통화 너머에서 모르는 사람이 애인의 이름을 먼저 대답했습니다.", effects:{danger:2,lazy:-1}},
          {text:"‘애인은 안전하다’고 한 번 말한다", end:"귀차니즘이 안도했고 통신실 위치를 전송했습니다.", effects:{lazy:3,investigation:2}, flag:"통신실 좌표", character:"lazy", rule:"phone"}
        ]},
        b4:{ messages:[
          ["SYSTEM","교탁 아래에서 찢어진 수칙서가 발견됩니다."],
          ["UNKNOWN","세 번째 줄은 읽지 마."]
        ], choices:[
          {text:"세 번째 줄까지 읽는다", end:"세 번째 줄에는 당신의 현재 행동이 적혀 있었습니다.", effects:{danger:3}, ending:"bad_school"},
          {text:"두 번째 줄까지만 읽는다", end:"수칙서 복원에 성공했습니다.", effects:{recovery:15,investigation:2}, rule:"school"},
          {text:"수칙서를 귀차니즘에게 읽어준다", end:"귀차니즘은 ‘그 목소리, 선생님 목소리가 아니에요’라고 답했습니다.", effects:{lazy:3,danger:1}, flag:"교내 방송 정체", character:"lazy"}
        ]}
      }
    }
  }
